...
namespace VibrationDevice
{
    class Program
    {
        ...
        private readonly static string deviceConnectionString = "HostName=umidade-hub.azure-devices.net;DeviceId=sensor-umidade;SharedAccessKey=A2mJ3zmLNBCnz2cF8Ndl+1Zeu/vlNKlWBzrpCWIMK+U=";
            ...
            double vibration)
        {
            ...
            telemetryMessage.Properties.Add("sensorID", "sensor-umidade");
            ...
            double vibration)
        {
            ...
            // Add a custom application property to the message. This is used to route the message.
            loggingMessage.Properties.Add("sensorID", "sensor-umidade");
